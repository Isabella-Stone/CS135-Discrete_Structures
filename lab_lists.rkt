...
(define (pig-latin word)
  (append (cdr word) (append (list (car word)) '(a y))))
...
;; 2 PTS
(define (rotate c)
 (list c (list (car (cdr c)) (- 0 (car c))) (list (- 0 (car c)) (- 0 (car (cdr c)))) (list (- 0 (car (cdr c))) (car c))))
...
;; 1 PTS
(define (get-gpa s)
  (car (cdr (cdr (car (cdr (cdr (reverse s))))))))
...
;; 2 PTS
(define (get-state s)
  (car (cdr (car (cdr (car (cdr (reverse s))))))))
